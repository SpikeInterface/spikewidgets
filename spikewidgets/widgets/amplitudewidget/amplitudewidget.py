...
class AmplitudeWidget(BaseMultiWidget):
    def __init__(self, *, recording, sorting, unit_ids=None, max_num_waveforms=100, type='hist', figure=None, ax=None):
